...
module.exports = {
  name: "pause",
  description: "Останавливает воспроизведение текущей музыки.",
  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(success ? '**Музыка была приостановлена ​​на мгновение!!**' : '❌ Command Error: Unable to pause song')
